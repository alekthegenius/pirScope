...
(function (root, factory) {
  ...
  Lightbox.prototype.changeImage = function(imageNumber) {
    ...
    this.album[imageNumber].link = this.album[imageNumber].link || this.album[imageNumber].src;
    this.$lightbox.find('.lb-download').attr('href', this.album[imageNumber].link);
